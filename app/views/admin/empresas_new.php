    ...
    $("div[data-role*='page']").live('pageshow', function() { 
        ...
        $("#submit").click(function(){
            ...
            $.ajax({
                ...
                data: formData,
                success: function(){
                    //$(location).attr('href','<?= Front::myUrl('admin/empresas'); ?>');
                    history.back();
                }
            });
...
<div id="titulo2">Agregar Empresa</div>
...
<form id="form1" method="post">
    ...
    <div data-role="fieldcontain">
        ...
        <input type="text" id="r9site_titulo" name="r9site_titulo">

        
        <label style="font-weight:bold" for="r9datasource">Base de datos</label>
        <input type="text" id="r9datasource" name="r9datasource">
        ...
        <select name="r9envio_email" id="r9envio_email" data-role="slider">
            <option value="0" <?php if ($datos["envio_email"] == 0) echo 'selected'; ?> >NO</option>
            <option value="1" <?php if ($datos["envio_email"] == 1) echo 'selected'; ?> >SI</option>
        </select>
