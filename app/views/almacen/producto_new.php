...
<form id="form1" action="index.php" data-transition="slide"  method="post">
    ...
    <div data-role="fieldcontain">
        ...
        <input type="text" data-mini="true" id="r0codalt" name="r0codalt" />
        ...
        <input type="text" data-mini="true" id="r0nomalt" name="r0nomalt" />
        ...
        <textarea name="r0resumen" id="r0resumen"> </textarea>
       ...
       <label style="font-weight:bold" for="r0iva">Tipo IVA</label>
        ...
        <input type="number" data-mini="true" id="r0precio_a" name="r0precio_a" />

        <label style="font-weight:bold" for="r0precio_a">Precio B</label>
        <input type="number" data-mini="true" id="r0precio_b" name="r0precio_b" />

        <label style="font-weight:bold" for="r0precio_a">Precio C</label>
        <input type="number" data-mini="true" id="r0precio_c" name="r0precio_c" />

        <label style="font-weight:bold" for="r0precio_a">Precio D</label>
        <input type="number" data-mini="true" id="r0precio_d" name="r0precio_d" />
        <p>&nbsp;</p>

        <label style="font-weight:bold" for="r0des_a">Desc. A</label>
        <input type="number" data-mini="true" id="r0des_a" name="r0des_a" />

        <label style="font-weight:bold" for="r0des_a">Desc. B</label>
        <input type="number" data-mini="true" id="r0des_b" name="r0des_b" />

        <label style="font-weight:bold" for="r0des_c">Desc. C</label>
        <input type="number" data-mini="true" id="r0des_c" name="r0des_c" />

        <label style="font-weight:bold" for="r0des_c">Desc. D</label>
        <input type="number" data-mini="true" id="r0des_d" name="r0des_d" />
        ...
        <input type="number" data-mini="true" id="r0exmin" name="r0exmin" />

        <label style="font-weight:bold" for="r0exmax">Exist. max</label>
        <input type="number" data-mini="true" id="r0exmax" name="r0exmax" />


        <label style="font-weight:bold" for="r0precio_min">Precio min.</label>
        <input type="number" data-mini="true" id="r0precio_min" name="r0precio_min" />

        <label style="font-weight:bold" for="r0precio_max">Precio max.</label>
        <input type="number" data-mini="true" id="r0precio_max" name="r0precio_max" />

        <label style="font-weight:bold" for="r0peso">Peso</label>
        <input type="number" data-mini="true" id="r0peso" name="r0peso" />

        <label style="font-weight:bold" for="r0altura">Altura</label>
        <input type="number" data-mini="true" id="r0altura" name="r0altura" />  

        <label style="font-weight:bold" for="r0ancho">Ancho</label>
        <input type="number" data-mini="true" id="r0ancho" name="r0ancho" /> 

        <label style="font-weight:bold" for="r0profun">Profundidad</label>
        <input type="number" data-mini="true" id="r0profun" name="r0profun" /> 
        ...
        <input type="number" data-mini="true" id="r0cantidad" name="r0cantidad" /> 
